...
// Requête SQL pour récupérer les informations des médecins spécialisés en dermatologie
...
if ($result->num_rows > 0) {
    // Affichage des informations de chaque médecin spécialisé en dermatologie
    echo "<h1>Médecins spécialisés en Dermatologie</h1>";
    ...
    echo "Aucun médecin spécialisé en Dermatologie trouvé.";
}
