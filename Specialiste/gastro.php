...
// Requête SQL pour récupérer les informations des médecins spécialisés en Gastro-Entérologie
...
if ($result->num_rows > 0) {
    // Affichage des informations de chaque médecin spécialisé en Gastro-Entérologie
    echo "<h1>Médecins spécialisés en Gastro-Entérologie</h1>";
    ...
    echo "Aucun médecin spécialisé en Gastro-Entérologie trouvé.";
}
