...
<head>
    ...
    <?php   
        function afficherRDV($db_handle, $idMedecin){
            ...
            //echo "SELECT * FROM RDV INNER JOIN Utilisateur ON RDV.Id_Client = Utilisateur.Id_User WHERE Id_Medecin ='".$idMedecin."';";
            $idRDV=-1;
            $listeCommandes=[];
...
<body>
    ...
    ;
        ...
        echo $listeCommandes."</br>";
        if(isset($_POST["annuler"])) {
            mysqli_query($db_handle,$listeCommandes[$_POST["annuler"]]);
            echo $listeCommandes[$_POST["annuler"]]."</br>";
